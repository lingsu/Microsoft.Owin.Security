    ...
    internal class WeChatAccountAuthenticationHandler : AuthenticationHandler<WeChatAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                string userInfoUri = string.Concat(UserInfoEndpoint ,
                    "?access_token=" , Uri.EscapeDataString(tokenResult.access_token) ,
                    "&openid=" , Uri.EscapeDataString(tokenResult.openid), "&lang=zh_CN"
                    );
                ...
                context.Identity = new ClaimsIdentity(new[]{
                    ...
                    new Claim(ClaimTypes.Gender, userInfo["sex"].ToString(),XmlSchemaString,Options.AuthenticationType),
                    new Claim(ClaimTypes.Country, userInfo["country"].ToString(),XmlSchemaString,Options.AuthenticationType),
                    new Claim(ClaimTypes.StateOrProvince, string.Concat(userInfo["province"].ToString()," ",userInfo["city"].ToString()),XmlSchemaString,Options.AuthenticationType),
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
               ...
               // Response.Cookies.Append(state, state2);
                string authorizationEndpoint =
                    "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" +
                        ...
                        //"&state=" + state +
                        "&state=" + Uri.EscapeDataString(challenge.Properties.RedirectUri) +
                        "#wechat_redirect";
